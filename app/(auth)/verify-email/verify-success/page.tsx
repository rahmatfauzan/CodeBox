...
import { Button } from "@/components/ui/button"; // Pastikan path import benar
      ...
      <div className="text-center space-y-6 animate-in fade-in zoom-in duration-500">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400 px-4">
            Email Anda berhasil diverifikasi. Anda siap untuk mulai mendokumentasikan kode Anda.
          </p>
        </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 rounded-xl p-5 text-left space-y-3">
          <p className="text-sm font-semibold text-slate-900 dark:text-white flex items-center gap-2">
            <Rocket className="w-4 h-4 text-indigo-600" /> Apa selanjutnya?
          </p>
        ...
        <div className="space-y-4 pt-2">
          <Button
            ...
            className="w-full bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white shadow-lg shadow-indigo-500/30 transition-all hover:scale-[1.02]"
            size="lg"
          >
            Masuk ke Dashboard
